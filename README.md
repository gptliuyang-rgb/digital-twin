...
**Simulation default is official Hand 2 Beta 2** (`hand2/hand2_beta2/`). Beta 1 remains ingested for drift comparison. Command vector is still 75-D (joint names unchanged).
...
hand/          controller, coupling, primitives, backends, tactile, calibration
...
## Facts already taken from official sources (2026-09-01)

Wuji Hand 2 **Beta 2**: 20 independent revolute DoF, no coupling, product curb mass 0.800 kg (soft + cables, excl. base; bare 0.650, base 0.070), sim no-mount 0.6228 kg including five tactile-pad links that **do collide**, MIT hybrid @ 1 kHz, 11–13 V, RJ45. Gains are still gen-1. Whole-hand soft body is not in sim.

Wuji Hand 2 **Beta 1** (kept for comparison): sim 0.6207 kg, pad meshes not in collision.
...
See `docs/SPEC_INTAKE.md`. The blockers for an honest twin are pad–cardboard friction, pad stiffness, hardware torque/gains, command latency, wrist CoM, T800 flange SE(3), and whether the physical unit is Beta 1 or Beta 2.
