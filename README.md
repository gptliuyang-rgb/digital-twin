...
wbc/           T800 SONIC contract, GMR IK export, 3/5-point teleop remap, L1a planner + Eq. 8 nav spring + 100 Hz operator loop + 500 Hz PD stream + S7 YAML obs gather + encoder motion_* look-ahead (default 10frame_step5 + low-latency 10frame_step1), G1-checkpoint guard
...
make eval-l1a-encoder     # SONIC encoder 842-D default + 831-D low-latency; no PICO, no G1 ONNX
```
