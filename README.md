...
wbc/           T800 SONIC contract, GMR IK export, 3/5-point teleop remap, L1a planner + Eq. 8 nav spring + 100 Hz operator loop + 500 Hz PD stream + S7 YAML obs gather + encoder motion_* look-ahead, G1-checkpoint guard
