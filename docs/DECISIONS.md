...
- **Consequences:** `make eval-l2-physics-sim2sim` adds 6 pos + 6 ori cases on pinned-base. A change in MPJPE across ±0.05 m is **not** a SONIC fail and **not** a Hand 2 calibration. PPO / GMR-on-BONES-SEED / combined weld remain blocked on flange SE(3) and wrist CoM.
