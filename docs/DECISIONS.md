...
- **Consequences:** `make eval-l1a-stream` dumps the factors. This is **not** SONIC's trained generative planner, **not** the operator 100 Hz loop, **not** the Hand 2 1 kHz MIT ring, **not** a pad–cardboard number, and **not** a flange/CoM substitute. PPO / GMR-on-BONES-SEED / combined weld remain blocked on flange SE(3) and wrist CoM.
