"""Free-base T800 lateral root-push and air-drop. Not a SONIC pass/fail.
...
success (ADR-026). A Table S4 +Y 0.5 m/s one-shot root velocity is a second
diagnostic. Air-drop (no floor) proves the freejoint. ``grasp_success_rate``
stays JSON null. Combined T800+Hand stays PolicyEvalBlocked.
"""
...
def run(*, source: str = "auto") -> dict[str, Any]:
    ...
    report = {
        ...
        "success_rate_note": "lean vs fall vs air-drop are diagnostics; not SONIC gates",
    }
